...
@pytest.mark.parametrize("a,expected", [
   (
    ...
    (
        ...
        [
            [(6, 6), (6, 9), (6, 12), (6, 16), (6, 25), (6, 28), (6, 31),
             (6, 35), (9, 6), (9, 9), (9, 12), (9, 16), (9, 25), (9, 28),
             (9, 31), (9, 35), (12, 6), (12, 9), (12, 12), (12, 16), (12, 25),
             (12, 28), (12, 31), (12, 35), (16, 6), (16, 9), (16, 12),
             (16, 16), (16, 25), (16, 28), (16, 31), (16, 35), (25, 6),
             (25, 9), (25, 12), (25, 16), (25, 25), (25, 28), (25, 31),
             (25, 35), (28, 6), (28, 9), (28, 12), (28, 16), (28, 25),
             (28, 28), (28, 31), (28, 35), (31, 6), (31, 9), (31, 12),
             (31, 16), (31, 25), (31, 28), (31, 31), (31, 35), (35, 6),
             (35, 9), (35, 12), (35, 16), (35, 25), (35, 28), (35, 31),
             (35, 35)],
...
# test overall the resulting linear combination from projection
...
def test_get_all_ao_product_projections(moProd, a, b, c, expected):
    """Test get_all_projection_of_ao_product method of MOProduct class"""
    result = moProd.get_all_ao_product_projections(a, b, c)

    for tup_ex, tup_res in zip(expected, result):
        assert tup_ex == tup_res, f"Tuples differ: {tup_ex} vs {tup_res}"
